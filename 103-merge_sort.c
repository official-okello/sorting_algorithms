...
/**
 * join_parse - joins and sorts the values in the array parsed
...
/**
 * parser - recursively perform merge sort and sort the given array
...
/**
 * merge_sort - application of the merge sort algorithm
 * @array: array to be sorted
